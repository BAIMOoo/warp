...
impl PlatformPageWidget {
    ...
    fn render_api_keys_header(
        ...
        header_row.add_child(
            ConstrainedBox::new(self.render_header_cell(appearance, "Key", app))
    ...
    fn render_resizable_header_cell(
        ...
        let header_cell = ConstrainedBox::new(
            Flex::row()
                ...
                .with_main_axis_size(MainAxisSize::Max)
                .with_child(
                    Expanded::new(1., self.render_header_cell(appearance, label, app)).finish(),
                )
                .with_child(
                    Container::new(
    ...
    fn render_api_key_row(
        ...
        if FeatureFlag::TeamApiKeys.is_enabled() || FeatureFlag::NamedAgents.is_enabled() {
            let scope_display = match key.scope {
                ...
                ApiKeyScope::Agent => localized_settings_text("Agent", app),
            };
            row.add_child(
                Expanded::new(
                    1.,
